...
def main():
    ...
    cur_dir = os.getcwd()
    train_dataset = MultiSessionsGraph(cur_dir + '/../exp/' + opt.dataset, phrase='train')

    train_loader = DataLoader(train_dataset, batch_size=opt.batch_size, shuffle=True)
    test_dataset = MultiSessionsGraph(cur_dir + '/../exp/' + opt.dataset, phrase='test')
    ...
    #torch.optim.lr_scheduler provides several methods to 
